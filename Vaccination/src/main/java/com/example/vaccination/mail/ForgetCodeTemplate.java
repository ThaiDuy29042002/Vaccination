...
public class ForgetCodeTemplate {
    ...
    public static String getTemplete(String firstname, String confirmCode) {
        String templete = "<head>\n"
                ...
                + "          max-width: 640px;\n"
                + "          background: #7289da\n"
                + "            url(https://www.bayer.com/sites/default/files/styles/3_1_aspect_ratio_large/public/2021-03/Corona_Impfung_Jumbotron_1440x590.jpg?h=5c643f6f&itok=IGddcHkW)\n"
                ...
                + "          align=\"center\"\n"
                + "          border=\"0\"\n"
                + "          background=\"https://www.bayer.com/sites/default/files/styles/3_1_aspect_ratio_large/public/2021-03/Corona_Impfung_Jumbotron_1440x590.jpg?h=5c643f6f&itok=IGddcHkW\"\n"
                + "        >\n"
                + "          <tbody>\n"
                + "            <tr>\n"
                + "              <td\n"
                ...
                + "                              your account on <b> Vaccination Platform  </b>.\n"
                + "                            </p>\n"
                + "                            <p>\n"
